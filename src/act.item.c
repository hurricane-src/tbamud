...
ACMD(do_drop)
{
    ...
    switch(subcmd)
    {
        ...
        case SCMD_DONATE:
            ...
            num_don_rooms = (CONFIG_DON_ROOM_1 != NOWHERE) * 2 + (CONFIG_DON_ROOM_2 != NOWHERE) + (CONFIG_DON_ROOM_3 != NOWHERE) + 1;
...
static void wear_message(struct char_data *ch, struct obj_data *obj, int where)
{
    const char *wear_messages[][2] = {{"$n lights $p and holds it.", "You light $p and hold it."},
...
static void perform_wear(struct char_data *ch, struct obj_data *obj, int where)
{
    ...
    const char *already_wearing[] = {"You're already using a light.\r\n",
...
int find_eq_pos(struct char_data *ch, struct obj_data *obj, char *arg)
{
    ...
    const char *keywords[] = {"!RESERVED!", "finger", "!RESERVED!", "neck", "!RESERVED!", "body", "head", "legs", "feet", "hands", "arms", "shield", "about", "waist", "wrist", "!RESERVED!", "!RESERVED!", "!RESERVED!", "\n"};
